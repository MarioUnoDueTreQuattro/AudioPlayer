...
void PlaylistView::moveEvent(QMoveEvent *event)
{
...
void PlaylistView::resizeEvent(QResizeEvent *event)
{
    ...
    settings.setValue("PlaylistViewGeometry", saveGeometry());
    // settings.setValue("windowState", saveState());
    // Call base implementation (optional if QWidget)
    QWidget::resizeEvent(event);
}

void PlaylistView::loadsettings()
{
    // Restore position
    ...
    QSettings settings;
    QPoint savedPos = settings.value("PlaylistViewPosition", QPoint(pos_x, pos_y)).toPoint();
    ...
    QByteArray geometry = settings.value("PlaylistViewGeometry").toByteArray();
    if (!geometry.isEmpty())
        restoreGeometry(geometry);
}

void PlaylistView::syncPlaylistOrder()
{
...
void PlaylistView::onHeaderSortChanged(int logicalIndex, Qt::SortOrder order)
{
